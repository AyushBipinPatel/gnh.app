...
#' @param colors Add colors through aes, provide name of the indicator with hexcolors
#'
...
hch_simple_column_chart <- function(data_passed,x_axis,y_axis,title,flname,
                                    tooltip,xtitle,ytitle,colors = "#181f86"){

  if(!stringr::str_detect(colors, "#")){
